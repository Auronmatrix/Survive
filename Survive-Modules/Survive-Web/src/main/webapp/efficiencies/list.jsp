            ...
            <table class="table">
                ...
                <c:forEach items="${actionBean.monsterWeapons}" var="monsterWeapon">
                    <tr>
                        ...
                        <td><s:link beanclass="com.muni.fi.pa165.actions.monster.MonsterActionBean" event="edit"><s:param name="monster.id" value="${monsterWeapon.monster.id}" /><c:out value="${monsterWeapon.monster.id}" /></s:link></td>
                        ...
                        <td><s:link beanclass="com.muni.fi.pa165.actions.weapon.WeaponActionBean" event="edit"><s:param name="weapon.id" value="${monsterWeapon.weapon.id}"/><c:out value="${monsterWeapon.weapon.id}" /></s:link></td>
